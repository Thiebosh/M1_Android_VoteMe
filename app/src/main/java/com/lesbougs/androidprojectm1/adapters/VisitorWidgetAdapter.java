...
import com.lesbougs.androidprojectm1.holders.VisitorWidgetHolder;
import com.lesbougs.androidprojectm1.model.Widget;

import java.util.ArrayList;
import java.util.Collections;

public class VisitorWidgetAdapter extends RecyclerView.Adapter<VisitorWidgetHolder> {
    ...
    @NonNull
    @Override
    public VisitorWidgetHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_widget, parent, false);
        return new VisitorWidgetHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull VisitorWidgetHolder holder, int position) {
